...
local python3_version = setmetatable({ _version = nil }, {
    __call = function(self)
        ...
        local s = system(vim.g.python3_host_prog ..
            " -W ignore -c 'import sys; print(list(sys.version_info)[:3])' 2>/dev/null")
...
local function autoinstall_pynvim()
    ...
    vim.api.nvim_echo({ { "Automatically installing pynvim for: " .. vim.g.python3_host_prog .. " ...", "Moremsg" } },
        true, {})
    vim.loop.sleep(100)
    vim.cmd [[ redraw! ]]
